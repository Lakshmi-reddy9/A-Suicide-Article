...
for line in input_mapper:
    ...
    if (len(data) == 12):
        ...
        # Writing age and suicides_number to output file
        output_mapper.write(age+","+suicides_number+"\n")
        # printing age and suicides_number to console
        print(age+","+suicides_number+"\n")
# Closing all files
input_mapper.close()
output_mapper.close()