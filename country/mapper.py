...
for line in input_mapper:
    ...
    if (len(data) == 12):
        ...
        # Writing country and suicides_number to output file
        output_mapper.write(country+","+suicides_number+"\n")
        # printing country and suicides_number to console
        print(country+","+suicides_number+"\n")
# Closing all files
input_mapper.close()
output_mapper.close()