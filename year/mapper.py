...
for line in input_mapper:
    ...
    if (len(data) == 12):
        ...
        # Writing year and suicides_number to output file
        output_mapper.write(year+","+suicides_number+"\n")
        # printing year and suicides_number to console
        print(year+","+suicides_number+"\n")
# Closing all files
input_mapper.close()
output_mapper.close()